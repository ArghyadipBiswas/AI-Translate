...
| Description | Link |
| ----------- | ---- |
| 📙 Colab Notebook | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/ArghyadipBiswas/AI-Translate/blob/main/SoniTranslate_Colab.ipynb) |
...
```
git clone https://github.com/ArghyadipBiswas/AI-Translate.git
cd AI-Translate
```
